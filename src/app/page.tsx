        ...
        <MaxWidthWrapper className='pb-24 pt-10 sm:pb-32 lg:grid lg:grid-cols-3 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52'>
          <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
            <div className='relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start'>
              <div className='absolute w-28 left-0 -top-20 hidden lg:block'>
                <img src='/snake-1.png' alt='snake hero' className='w-full'/>
              </div>
          ...
          <div className='col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20'>
            <div className='relative md:max-w-xl'>
              <img src='/your-image.png' alt='case image' className='absolute w-40 lg:w-52 left-56 -top-20 select-none hidden sm:block lg:hidden'/>
          ...
          <div className='mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16'>
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              ...
              <div className='text-lg leading-8'>
                <p>
                  "The case feels durable and I even got a compliment on the design. Had the case for two months npw and
              ...
              <div className='flex gap-4 mt-2'>
                <img src='/users/user-1.png' alt='use one' className='rounded-full h-12 w-12 object-cover'/>
            ...
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              ...
              <div className='text-lg leading-8'>
                <p>
                  "I usually keep my phone together widh my keys in my pocket and that led to some pretty heavy scratchmarks on all of my last phone cases. This one, besides a barely noticeable scratch on the corner,
                  {' '}<span className='p-0.5 bg-slate-800 text-white'>looks brand new after about half a year</span>. I dig it."
                </p>
              </div>
              <div className='flex gap-4 mt-2'>
                <img src='/users/user-4.jpg' alt='user four' className='rounded-full h-12 w-12 object-cover'/>
                <div className='flex flex-col'>
