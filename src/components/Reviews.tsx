...
function ReviewGrid() {
  ...
  return (
    <div ref={containerRef} className='relative -mx-4 mt-16 grid h-[49rem] max-h-[150vh] grid-cols-1 items-start gap-8 overflow-hidden px-4 sm:mt-20 md:grid-cols-2 lg:grid-cols-3'>
      ...
      <div className='pointer-events-none absolute inset-x-0 top-0 h-3 bg-gradient-to-b from-slate-100'/>
      <div className='pointer-events-none absolute inset-x-0 bottom-0 h-3 bg-gradient-to-t from-slate-100'/>
    </div>
  )
}
...
const Reviews = () => {
  return (
    <MaxWidthWrapper className='relative max-w-5xl'>
      <img aria-hidden='true' src='/what-people-are-buying.png' alt='people buying' className='absolute select-none hidden xl:block -left-32 top-1/3'/>
