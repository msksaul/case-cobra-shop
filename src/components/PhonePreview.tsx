...
const PhonePreview = ({ croppedImageUrl, color }: {
  ...
  return (
    <AspectRatio ref={ref} ratio={3000/2001} className='relative'>
      <div 
        className='absolute z-0 scale-[1.0352]' 
        style={{ 
      ...
      >
        <img
          width={renderedDimensions.width/ (3000/640)} 
          className={cn('phone-skew relative z-10 rounded-t-[15px] rounded-b-[10px] md:rounded-t-[30px] md:rounded-b-[20px]', caseBackgroundColor)} 
          src={croppedImageUrl} 
          alt='user image'
        />
      </div>
